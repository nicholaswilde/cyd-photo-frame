...
## Description
This skill compiles the `cyd-photo-frame` firmware for the ESP32 Cheap Yellow Device, handles any compilation issues, and ensures code quality by running subsequent validation tests.
