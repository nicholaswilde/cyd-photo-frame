...
- The utility script [capture-screenshots.sh](file:///home/nicholas/git/nicholaswilde/cyd-photo-frame/scripts/capture-screenshots.sh) must be executable.
...
After capturing new screenshots, reference them in the [README.md](file:///home/nicholas/git/nicholaswilde/cyd-photo-frame/README.md) file inside the screenshots section using HTML table or standard markdown image links.
